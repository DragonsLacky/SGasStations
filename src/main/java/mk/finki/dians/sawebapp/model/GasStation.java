...
/**
 * The class that represents a document from a database, with all the specified fields
 */
@Data
...
public class GasStation {
    ...
    /***
     * Calculates the distance between the current object and location passed as a parameter, and sets the distance of the current object in km(kilometers).
    ...
    public void distance(Location loc){
        ...
        this.distance =  Math.round((12742 * Math.asin(Math.sqrt(a)))*100)/100.0;
    }
}
